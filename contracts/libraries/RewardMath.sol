...
library RewardMath {
    ...
    /// @param liquidity The amount of liquidity, assumed to be constant over the period
    /// over which the snapshots are measured
    /// @param secondsPerLiquidityInsideInitialX128 The seconds per liquidity of the liquidity tick range
    ///  as of the beginning of the period
    /// @param secondsPerLiquidityInsideX128 The seconds per liquidity of the liquidity tick range as of
    ...
    function computeRewardAmount(ComputeRewardAmountParams memory params)
        internal
        pure
        returns (
            uint256 reward,
